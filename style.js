(function() {
    ...
    function shiftPoint(p) {
        (p, 1+1*Math.random(), {x:p.originX-50+Math.random()*100,
...
btn.onclick = function() {
    let hez1= document.querySelector('.hex1');
    let hez2= document.querySelector('.hex2');
    let hez3= document.querySelector('.hex3');
    let hez4= document.querySelector('.hex4');
    hez1.style.display = 'block';
    hez2.style.display = 'block';
    hez3.style.display = 'block';
    hez4.style.display = 'block';
};
